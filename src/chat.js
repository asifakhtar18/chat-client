        ...
        <div className="flex h-screen ">
            ...
            <div className="flex flex-col bg-blue-50 w-2/3 p-2 ">
                                ...
                                <div className={"border-bottom  text-left inline-block p-2 my-2 rounded-md text-sm " +(message.sender === id ? 'bg-blue-500 text-white' : 'bg-white text-blue-500')}>
                                    ...
                                    {message.file && (
                                        ...
                                        <div className="max-w-sm" >
                                            <img src={`http://localhost:4000/uploads/${message.file}`}  alt=""  />
                ...
                {!!selectedUserId && (
                    ...
                    <form className="msg flex gap-1 " onSubmit={sendMesaage}>
                        <input 
                        ...
                        {!newMessageText? (
                            ...
                            <input type="file" accept=".jpg, .jpeg, .png" className="hidden" onChange={sendFile}  />
